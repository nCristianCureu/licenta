...
function CartPage() {
  ...
  const cart = useSelector((state) => state.cart); //return state.cart
  ...
  useEffect(() => {
    ...
    stripeToken && cart.total >= 1 && makeRequest(); //If stripeToken exists, call the function
